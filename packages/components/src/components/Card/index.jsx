 ...
 * wrapps content inside a container. It adds box-shadow to the wrapper element
 * so the content appears to be floating.
 */
const Card = ({
  children,
  image,
  ...
  <div className={`${styles.card} ${className || ""}`} {...props}>
    {image && (
      ...
      >
        {imageAspectRatio && <div>{image}</div>}
...
Card.propTypes = {
   ...
   */
  imageAspectRatio: PropTypes.oneOf([
    "16:9",
    "4:3",
    "4:1",
    "21:9",
