...
export default {
  title: "Examples/CroCoder Jobs/Subscribe",
  parameters: {
    docs: { page: null },
  },
  component: Grid,
...
export const Story1 = () => (
  <>
    ...
    >
      ...
      />
      <Button style={{ gridColumn: "3 / span 1", gridRow: "1 / span 1" }}>
        {" "}
        Submit
      </Button>
      <Flexbox
        alignItems="baseline"
        style={{ gridColumn: "1 / span 2", gridRow: "2 / span 1" }}
      >
        <Icon
          fontSize={14}
          color="gray_2"
        ...
        <Typography fontSize={16} color="gray_2">
          A confirmation of terms of services{" "}
        </Typography>
      </Flexbox>
    </Grid>
  </>
...
export const Story3 = () => (
  <>
    ...
    >
      ...
      />
      <Button style={{ gridColumn: "1 / span 1", gridRow: "3 / span 1" }}>
        {" "}
        Submit
      </Button>
      <Flexbox
