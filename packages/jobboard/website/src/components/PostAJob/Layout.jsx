      ...
      <Flexbox className={styles.flex}>
        ...
        <div className={styles.leftContainer}>
          <Flexbox direction="column" className={styles.float}>
            <Typography fontFamily="rubik" className={styles.title} color="green_4" fontWeight={700} fontSize={50}>{title}</Typography>
            <Typography fontFamily="roboto" className={styles.subtitle} color="gray_2" fontSize={18}><span dangerouslySetInnerHTML={{__html: subtitle}}></span></Typography>
            <Typography fontFamily="roboto" className={styles.text} color="gray_2" fontSize={18}><span dangerouslySetInnerHTML={{__html: text}}></span></Typography>
